...
export default function Contato() {
    ...
    return (
        <div id="contato" className="w-screen flex flex-col px-[10vw] mt-32 scroll-mt-32">
            ...
            <div className="flex flex-col desktop:w-[50%] mobile:w-full gap-12">
                ...
                <button className="bg-vermelho px-8 py-4 text-base after:content-['_►'] w-[50%] ml-[50%] hover:animate-pulse">Enviar</button>
            </div>
        </div>
    );
